...
function getFeedHtml(){
    // console.log(tweetsData1)
    // console.log(JSON.parse(newData))
    
    localStorage.setItem('tweetsLocalStorage',JSON.stringify(tweetsData1))
    // console.log(localStorage.getItem('tweetsLocalStorage'))
    // if(!flag && localStorage.getItem('tweetsLocalStorage')){
    //     tweetsData1=JSON.parse(localStorage.getItem('tweetsLocalStorage'))
    //     flag=true;
    //     console.log(tweetsData1)
    // }
    ...
    tweetsData1.forEach(function(tweet){
        ...
        let hiddenClass=''
        if(tweet.handle!==loggedInUserHandle){
            hiddenClass='hidden'
        }
...
function render(){
    // localStorage.setItem('tweetsLocalStorage',JSON.stringify(newData))
